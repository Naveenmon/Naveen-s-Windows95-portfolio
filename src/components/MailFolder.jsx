...
const form = useRef();
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_lkaa5tp', 'template_bu4kosj', form.current, {
        publicKey: 'EEqK-RG5r0PiZgspb',
      })
      .then(
        () => {
          clippyThanksYouFunction()
            ...
            <form ref={form} onSubmit={sendEmail}>
              ...
              <div className="form_container">
                ...
                <div className="sendmail_icon">
                  ...
                  <input className="myemail_container" placeholder='navenarumugam2003@gmail.com' disabled style={{background: '#d4d1d1'}} />
                </div>
                <div className="to_container">
